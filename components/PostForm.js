    ...
    return(
        <Card>
            <div className="flex items-center gap-3">
                ...
                className="grow md:py-3 md:px-3 h-14 border-4 border-gray-50" placeholder={`Care to share, ${(profile) ? profile?.name : `user`}?`}></textarea>
            </div>
            {uploading && (
                <div>
                    <Spinner></Spinner>
            ...
            <div className="flex gap-5 items-center mt-2">
                ...
                <div>
                    <button onClick={workingOnIt} className="flex md:gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <div>
                    <button onClick={workingOnIt} className="flex md:gap-1 whitespace-nowrap">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
