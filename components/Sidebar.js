...
export default function Sidebar () {
    ...
    return(
        <Card noPadding={true}>
            <div className="z-9999 sticky pl-5 -mr-6 gap-1 grow overflow-hidden p-1 flex justify-evenly items-center text-left md:block shadow-md shadow-gray-500 md:shadow-none pt-1">
