...
export default function Sidebar () {
    ...
    return(
        <Card noPadding={true}>
            <div className="z-9999 sticky ml-1 mr-1 overflow-hidden p-1 flex justify-between items-center text-left md:block shadow-md shadow-gray-500 md:shadow-none pt-1">
